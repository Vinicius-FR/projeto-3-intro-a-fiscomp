...
open(1, file = 'exerC1_out.dat', status = 'replace') !criando tabela de theta em função de t
OPEN(2, file = 'energiaC1_out.dat', status = 'replace') !criando tabela de energia em função de t para o gráfico
...
do i = 1, n
    ...
    theta = theta_0 + w_0 * dt !!calculando o ângulo de oscilação após dt pelo método de Euler
